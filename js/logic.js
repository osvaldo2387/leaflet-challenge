// tile layers for the differnet backgorunds of the map:
// grayscale background.
var graymap_background = L.tileLayer("https://api.mapbox.com/styles/v1/mapbox/light-v9/tiles/256/{z}/{x}/{y}?" +
  "access_token=pk.eyJ1Ijoib3N2YWxkbzIzODciLCJhIjoiY2swcmRqODRuMDU5bjNpbmw2dDE0bWQxdyJ9.ewd3xZXL_5A_kg-9orvG0w");
...
// set the layers for two different sets of data, earthquakes and tectonic plates.
...
// control for making the layers visible.
L
  .control
  .layers(baseMaps, overlayMaps)
  .addTo(map);

// get the last month earthquake geoJSON data.
